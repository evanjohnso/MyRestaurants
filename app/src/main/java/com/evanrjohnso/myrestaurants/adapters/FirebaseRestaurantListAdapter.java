package com.evanrjohnso.myrestaurants.adapters;
...
import com.evanrjohnso.myrestaurants.ui.RestaurantDetailFragment;
import com.evanrjohnso.myrestaurants.util.ItemTouchHelperAdapter;
...
public class FirebaseRestaurantListAdapter extends FirebaseRecyclerAdapter<Restaurant, FirebaseRestaurantViewHolder> implements ItemTouchHelperAdapter {
    ...
    public FirebaseRestaurantListAdapter(Class<Restaurant> modelClass,
        ...
        mContext = context; //needed to create intent
