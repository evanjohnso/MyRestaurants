...
public class YelpService {
    ...
    public static void findRestaurants(String inputLocation, Callback callback) {

        OkHttpClient clientSide = new OkHttpClient.Builder().build();

        HttpUrl.Builder urlBuilder = HttpUrl.parse(Constants.YELP_BASE_URL).newBuilder();
        urlBuilder.addQueryParameter(Constants.YELP_LOCATION_QUERY_PARAMETER, inputLocation);
        ...
        Call call = clientSide.newCall(request);
        call.enqueue(callback); //asynchronous versus call.execute()
